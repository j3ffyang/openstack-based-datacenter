...
part /var --fstype="ext4" --size=204800 --label=OS_VAR #--onpart=LABEL=OS_VAR #--onbiosdisk=80
part /gemini --fstype="ext4" --grow --size=1 --label=Gemini #--onpart=LABEL=OS_VAR #--onbiosdisk=80
